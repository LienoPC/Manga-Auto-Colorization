...
if __name__ == '__main__':
    ...
    # Define the data loader
    train_loader = torch.utils.data.DataLoader(training_set, sampler=train_sample, batch_size=batch_size, drop_last=False, pin_memory=False, persistent_workers=False)
    valid_loader = torch.utils.data.DataLoader(training_set, sampler=valid_sample, batch_size=batch_size, drop_last=False, pin_memory=False, persistent_workers=False)
    ...
    adv_train(module, discriminator, train_loader, valid_loader, device=device, gen_optimizer=gen_optimizer, disc_optimizer=disc_optimizer, epochs=num_epochs)
